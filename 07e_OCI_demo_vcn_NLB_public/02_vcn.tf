# ------ Create a new VCN
resource oci_core_virtual_network tf-demo07e-vcn {
...
resource oci_core_internet_gateway tf-demo07e-ig {
  ...
  vcn_id         = oci_core_virtual_network.tf-demo07e-vcn.id
}
...
resource oci_core_subnet tf-demo07e-public-subnet {
  ...
  dhcp_options_id     = oci_core_virtual_network.tf-demo07e-vcn.default_dhcp_options_id
}
