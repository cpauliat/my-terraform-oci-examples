resource oci_database_db_home cluster3_dbhome1 {
    vm_cluster_id = oci_database_vm_cluster.cluster3.id
    display_name  = var.dbhome1_display_name
    source        = "VM_CLUSTER_NEW"
    freeform_tags = { "Department" = "cpauliat" }    
    db_version    = var.dbhome1_version
...
# oci_database_db_home.cluster3_dbhome1: Destruction complete after 6m7s