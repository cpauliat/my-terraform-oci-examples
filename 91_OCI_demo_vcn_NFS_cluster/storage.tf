...
output fs1_blockvolume {
  value = (var.fs_ha ? (local.derived_storage_server_node_count/2)*local.derived_fs1_disk_count : local.derived_fs1_disk_count * local.derived_storage_server_node_count)
}

output fs2_blockvolume {
  value = (var.fs_ha ? (local.derived_storage_server_node_count/2)*local.derived_fs2_disk_count : local.derived_fs2_disk_count * local.derived_storage_server_node_count)
}

output fs3_blockvolume {
  value = (var.fs_ha ? (local.derived_storage_server_node_count/2)*local.derived_fs3_disk_count : local.derived_fs3_disk_count * local.derived_storage_server_node_count)
}
