...
data oci_core_images OLImageOCID-ol7-tenant2 {
...
resource oci_core_instance demo13b-tenant2 {
  provider            = oci.tenant2
  ...
  compartment_id      = var.compartment_ocid2
  display_name        = "demo13b-tenant2"
  shape               = "VM.Standard2.1"

  source_details {
    source_type = "image"
    source_id   = data.oci_core_images.OLImageOCID-ol7-tenant2.images[0]["id"]
  }
