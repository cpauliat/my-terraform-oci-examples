...
data oci_core_images OLImageOCID-ol7-tenant1 {
...
resource oci_core_instance demo13b-tenant1 {
  provider            = oci.tenant1
  ...
  compartment_id      = var.compartment_ocid1
  display_name        = "demo13b-tenant1"
  shape               = "VM.Standard2.1"

  source_details {
    source_type = "image"
    source_id   = data.oci_core_images.OLImageOCID-ol7-tenant1.images[0]["id"]
  }
