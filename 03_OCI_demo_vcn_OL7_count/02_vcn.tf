...
# ------ Create a new VCN
resource oci_core_virtual_network tf-demo03-vcn {
...
resource oci_core_internet_gateway tf-demo03-ig {
  ...
  vcn_id         = oci_core_virtual_network.tf-demo03-vcn.id
}
...
# availability_domain = data.oci_identity_availability_domains.ADs.availability_domains[var.AD - 1]["name"]
  ...
  dhcp_options_id     = oci_core_virtual_network.tf-demo03-vcn.default_dhcp_options_id
}
