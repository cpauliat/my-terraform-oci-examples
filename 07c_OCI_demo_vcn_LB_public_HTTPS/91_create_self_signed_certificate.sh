...
openssl req -new -key ca.key -out ca.csr -subj "/C=FR/ST=PACA/L=Aix/O=cpauliat/OU=home/CN=toto.cpauliat.tk"
openssl x509 -req -in ca.csr -signkey ca.key -out ca.crt
openssl genrsa -out loadbalancer.key 2048
openssl req -new -key loadbalancer.key -out loadbalancer.csr -subj "/C=FR/ST=PACA/L=Aix/O=cpauliat/OU=home/CN=toto.cpauliat.tk"
